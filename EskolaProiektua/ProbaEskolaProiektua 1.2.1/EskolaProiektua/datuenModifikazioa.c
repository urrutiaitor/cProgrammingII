...
void DATUENMODIFIKAZIOA_ikasleBatSartu(ESKOLA eskolak[ESKOLAMAX]){
	...
	if ((eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleKopurua >= IKASLEAKMAX) || (eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].aukeragarri==0)){
		...
		DATUENMODIFIKAZIOA_ikaslearenIkasgaiakSartu(eskolak, eskolak[0].aukeratutakoEskola, gela);
...
void DATUENMODIFIKAZIOA_irakasleakAsignatu(ESKOLA eskolak[ESKOLAMAX]){
	...
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].irakasleak[ikasgaia - 1].izena);
	fflush(stdin);
	printf("Zein abizen du irakasleak?\n");
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila - 1].irakasleak[ikasgaia - 1].abizena);
	fflush(stdin); 
...
void DATUENMODIFIKAZIOA_tutoreaAsignatu(ESKOLA eskolak[ESKOLAMAX]){
	...
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].tutorea.izena);
	fflush(stdin);
	printf("Zein abizen du tutoreak?\n");
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].tutorea.abizena);
	fflush(stdin);
...
void DATUENMODIFIKAZIOA_batenDatuakSartu(ESKOLA eskolak[ESKOLAMAX],int gela){
	...
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleak[eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleKopurua].izena);
	fflush(stdin);
	printf("Zein da ikaslearen abizena?\n");
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleak[eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleKopurua].abizena);
	fflush(stdin);
...
void DATUENMODIFIKAZIOA_ikasgaiakSartu(ESKOLA eskolak[ESKOLAMAX]){
	...
	do{
		...
		for (i = 0; i < IKASGAIMAX; i++){
			printf("%i. %s\n", i + 1, eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasgaiak[i].izena);
		}
		scanf("%i", &aukera);
		aukera = aukera - 1;
		if (eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleak[eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleKopurua].ikasgaiak[aukera].aukeratuta == 1){
			printf("Ikasgai hori aukeratuta daukazu\n");
		}
		if (eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleak[eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleKopurua].ikasgaiak[aukera].aukeratuta == 0){
			eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleak[eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleKopurua].ikasgaiak[aukera].aukeratuta = 1;
...
void DATUENMODIFIKAZIOA_ikasgaiakSartuAdministrazioa(ESKOLA eskolak[ESKOLAMAX]){
	...
	for (i = 0; i < IKASGAIMAX; i++){
		...
		gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasgaiak[i].izena);
...
void DATUENMODIFIKAZIOA_eskolakoMailakJarri(ESKOLA eskolak[ESKOLAMAX]){
	...
	gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].maila);
	eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].aukeragarri = 1;
}