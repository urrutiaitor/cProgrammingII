...
void DATUENMODIFIKAZIOA_ikasleBatSartu(ESKOLA eskolak[ESKOLAMAX]){
	...
	//programa
	gela = BISTARATU_gelaAukeratu(eskolak);
	if (eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleKopurua == IKASLEAKMAX){
	...
	while (segi == 1){
		...
		for (i = 0; i < IKASGAIMAX; i++){
			if (eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleak[eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasleKopurua].ikasgaiak[i].aukeratuta == 0){
				printf("%i. %s", i, eskolak[eskolak[0].aukeratutakoEskola].gelak[gela].ikasgaiak[i].izena);
			}
		}
		scanf("%i", &aukera);
		fflush(stdin);
...
void DATUENMODIFIKAZIOA_ikasgaiakSartu(ESKOLA eskolak[ESKOLAMAX]){
	...
	while (kont < 10){
		...
		gets(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasgaiak[kont].izena);
		eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasgaiak[kont].aukeratuta = 1;
		for (i = 0; i < IKASLEAKMAX; i++){
			strcpy(eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasleak[i].ikasgaiak[kont].izena, eskolak[eskolak[0].aukeratutakoEskola].gelak[maila].ikasgaiak[kont].izena);
		}
		kont++;
	}
	system("cls");
