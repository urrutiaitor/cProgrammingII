...
void DATUENMODIFIKAZIOA_eskolakoDatuakSartu(USUARIO **usuarioa_ptr_ptr,ESKOLA **eskola_ptr_ptr){
	//aldagaiak

	//programa
	DATUENMODIFIKAZIOA_eskolakoIzenaModifikatu(usuarioa_ptr_ptr,eskola_ptr_ptr);

	DATUENMODIFIKAZIOA_eskolakoHelbideaModifikatu(usuarioa_ptr_ptr, eskola_ptr_ptr);
	
	DATUENMODIFIKAZIOA_eskolakoTelefonoaModifikatu(usuarioa_ptr_ptr,eskola_ptr_ptr);
...
void DATUENMODIFIKAZIOA_eskolakoDatuakModifikatu(USUARIO **usuarioa_ptr_ptr, ESKOLA **eskola_ptr_ptr){
	//aldagaiak
	int aukera = 0;
...
void DATUENMODIFIKAZIOA_ikasleakGeletanBanatu(USUARIO **usuarioa_ptr_ptr, ESKOLA **eskola_ptr_ptr){

} //hasiera batean funtzio hau ez da egongo erabilgarri

void DATUENMODIFIKAZIOA_gelaFisikoaAsignatu(usuarioa_ptr_ptr, eskola_ptr_ptr){
	//aldagaiak
	int i = 0;
	int kont = 1;
...
void DATUENMODIFIKAZIOA_eskolakoIzenaModifikatu(USUARIO **usuarioa_ptr_ptr, ESKOLA **eskola_ptr_ptr){
	fflush(stdin);
...
void DATUENMODIFIKAZIOA_eskolakoHelbideaModifikatu(USUARIO **usuarioa_ptr_ptr, ESKOLA **eskola_ptr_ptr){
...
void DATUENMODIFIKAZIOA_eskolakoTelefonoaModifikatu(USUARIO **usuarioa_ptr_ptr, ESKOLA **eskola_ptr_ptr){
