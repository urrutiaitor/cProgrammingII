...
int kateakKonparatu(char *katea_ptr_1, char *katea_ptr_2);
...
int main(){
	...
	emaitza=kateakKonparatu(katea_ptr_1,katea_ptr_2);
	if (emaitza > 0){
...
int kateakKonparatu(char *katea_ptr_1, char *katea_ptr_2){
	...
	while ((i < MAX) && (bukatu == 0)){
		if ((*(katea_ptr_1 + i) == '\0') && (*(katea_ptr_2 + i) == '\0')){
			emaitza = 0;
			bukatu = 1;
		}
		if ((*(katea_ptr_1 + i) == '\0') && (*(katea_ptr_2 + i) != '\0')){
		...
		if (*(katea_ptr_1 + i) > *(katea_ptr_2 + i)){
			emaitza = +1;
			bukatu = 1;
		}
		if (*(katea_ptr_1 + i) < *(katea_ptr_2 + i)){
